...
# Scheme name: wallust
# Scheme author: Someone idk, me ig
...
c.colors.downloads.start.bg = base13

# Color gradient end for download text.
c.colors.downloads.stop.fg = foreground

# Color gradient stop for download backgrounds.
c.colors.downloads.stop.bg = base12
...
c.colors.messages.warning.bg = base14

# Border color of a warning message.
c.colors.messages.warning.border = base14
...
c.colors.statusbar.normal.fg = base11
...
c.colors.statusbar.insert.bg = base13

# Foreground color of the statusbar in passthrough mode.
c.colors.statusbar.passthrough.fg = base00

# Background color of the statusbar in passthrough mode.
c.colors.statusbar.passthrough.bg = base12
...
c.colors.statusbar.caret.bg = base14

# Foreground color of the statusbar in caret mode with a selection.
c.colors.statusbar.caret.selection.fg = base00

# Background color of the statusbar in caret mode with a selection.
c.colors.statusbar.caret.selection.bg = base13

# Background color of the progress bar.
c.colors.statusbar.progress.bg = base13
...
# (http).
c.colors.statusbar.url.success.http.fg = base12
...
c.colors.statusbar.url.warn.fg = base14

# Background color of the tab bar.
c.colors.tabs.bar.bg = background

# Color gradient start for the tab indicator.
c.colors.tabs.indicator.start = base13

# Color gradient end for the tab indicator.
c.colors.tabs.indicator.stop = base12
...
c.colors.tabs.pinned.even.bg = base12

# Foreground color of pinned unselected even tabs.
c.colors.tabs.pinned.even.fg = foreground

# Background color of pinned unselected odd tabs.
c.colors.tabs.pinned.odd.bg = base11
